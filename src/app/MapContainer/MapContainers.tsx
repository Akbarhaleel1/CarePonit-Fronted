...
//   const [doctorLocation, setDoctorLocation] = useState<LatLngTuple | null>(
//     null
//   );
...
//           "/doctor-service/selectedDoctorForMapTracking",
//           { doctorEmail }
//         );
...
//         L.Routing.control({
//           waypoints: [L.latLng(userLocation), L.latLng(doctorLocation)],
//           lineOptions: {
...
//   return (
//     <MapContainer
//       center={userLocation || [8.491, 76.9538]}
//       zoom={13}
//       className="h-[100vh] mt-5 w-[90%] xl:w-[95%] xl:ml-9 ml-[5%] rounded-xl"
//       id="map"
//     >
//       <TileLayer
