...
// //     {
// //       label:(
// //         <span className="text-white dark:text-neutral-200">Appoinment</span>
// //       ),
...
//     },
//     {
//       label: <span className="text-white dark:text-neutral-200">Appoinment</span>,
//       href: "/doctor/appoinments",
//       icon: <IconUserBolt className="text-white dark:text-neutral-200 h-5 w-5 flex-shrink-0" />,
//     },
//     {
...
//       href: "/doctor/chat",
//       icon: <MessageCircle className="text-white dark:text-neutral-200 h-5 w-5 flex-shrink-0" />,
//     },
//     {
//       label: <span className="text-white dark:text-neutral-200" onClick={() => logout()}>Logout</span>,
//       href: "/login",
