          ...
          const demoOrders: Order[] = [
            {
              ...
              total: 120.50,
              items: [
                { id: '1', name: 'Painkillers', quantity: 2, price: 20.25 },
                { id: '2', name: 'Vitamins', quantity: 1, price: 80.00 },
              ],
            },
            {
              id: '2',
              ...
              total: 200.00,
              items: [
                { id: '3', name: 'Antibiotics', quantity: 1, price: 100.00 },
                { id: '4', name: 'Cough Syrup', quantity: 2, price: 50.00 },
              ],
            },
            {
              id: '3',
              ...
              total: 75.00,
              items: [
                { id: '5', name: 'Allergy Medication', quantity: 3, price: 25.00 },
              ],
            },
            {
              id: '4',
              ...
              total: 150.00,
              items: [
                { id: '6', name: 'Cold Medicine', quantity: 1, price: 150.00 },
              ],
            },
          ];
